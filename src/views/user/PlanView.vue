<template>
  <Navigation
    ><v-container class="py-5 scrollable">
      <!-- Titre principal -->
      <v-row style="gap: 1em" justify="center">
        <v-col cols="12" class="text-center">
          <h2 class="text-h5 my-4 font-weight-bold text-primary">
      ...
      <v-row justify="center" align="center" dense>
        ...
        >
          <v-card
            ...
            outlined
            style="height: 10em"
            class="py-2 hoverable text-center elevation-2 rounded-xl hover-card"
          >
            <v-card-title>
